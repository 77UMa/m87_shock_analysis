...
def _base_pipeline_config():
    return {
        ...
        "physics": {
            ...
            "advection_seed_kernel_r": 2,
            "advection_seed_kernel_theta": 1,
            "advection_seed_kernel_phi": 1,
            "advection_seed_mode": "downstream_sample",
            "advection_seed_merge_fraction": 0.25,
            "advection_transport_merge_fraction": 0.25,
            "advection_kernel_downstream_bias": 0.5,
            "cooling_factor": 50.0,
