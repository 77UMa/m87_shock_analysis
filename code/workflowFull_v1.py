...
# ==============================================================================
# IPOLE 与可视化辅助函数 (从 workflowFull_v1.4.0.py 恢复)
# ==============================================================================
...
if __name__ == '__main__':
    ...
    config = {
        ...
        "output_directory": os.path.join(CPFS_ROOT_PATH, "workflow_output_DSA_run_01/"), # 建议为新运行设置新输出目录
        ...
        "auto_cleanup": True, # [新增] 清理 ipole_input.h5
